...
eip: 3155
title: EVM Trace
description: Capturing EVM traces in JSON during execution of state tests.
...
Defines a JSON-based format for communicating the state of the EVM during execution. Useful for comparative testing and fuzzing of client implementations.
